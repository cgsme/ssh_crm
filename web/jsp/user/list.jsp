										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR 		
													...
													<TD>
													<s:property value="#user.user_code" />
													</TD>
													<TD>
													<s:property value="#user.user_name" />
													</TD>
													<TD>
													<s:property value="#user.user_password" />
													</TD>
													<TD>
															<%--判断用户状态 1：启用   0：禁用--%>
													...
													<TD>
															...
															&nbsp;&nbsp;
															<a href="${pageContext.request.contextPath }/UserAction?method=delete&user_id=${user.user_id}">删除</a>
													</TD>
												</TR>
												</s:iterator>
